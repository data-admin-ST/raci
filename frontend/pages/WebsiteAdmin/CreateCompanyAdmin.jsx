...
const CreateCompanyAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Remove password from form data - backend will generate temp password
      const userData = {
        name: formData.name,
      ...
      // Call the API to create a user with company_admin role
      const response = await apiService.post(env.usersUrl, userData);
