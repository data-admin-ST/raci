...
const EventMaster = () => {
  ...
  const handleSubmitEvent = async (e) => {
    ...
    try {
      ...
      // First create a JSON payload to properly structure the data
      const eventData = {
        name: eventForm.name,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <div className="content-wrapper fix-wrapper">
            ...
            <div className="card fix-card">
              ...
              <form onSubmit={handleSubmit} className="form-grid fix-form">
                ...
                {/* Simple Subtask Section - Updated with description field */}
      ...
      {/* Only keep the subtask form, remove the event list */}
      {renderSubtaskForm()}
    </div>
  );
};
