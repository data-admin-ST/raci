              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <p style={{ 
                    ...
                    Create detailed RACI matrices for your projects, easily assigning team members as:
                  </p>
                  <ul style={{
                    listStyleType: 'none',
                    padding: '0',
                    ...
                    <li style={{
                      ...
                      <span><strong>Responsible</strong> - Who performs the task</span>
                    </li>
                    <li style={{
                      padding: '0.5rem 0',
                      display: 'flex',
                      ...
                      <span><strong>Accountable</strong> - Who approves the work</span>
                    </li>
                    <li style={{
                      padding: '0.5rem 0',
                      display: 'flex',
                      ...
                      <span><strong>Consulted</strong> - Who provides input</span>
                    </li>
                    <li style={{
                      padding: '0.5rem 0',
                      display: 'flex',
                      ...
                      <span><strong>Informed</strong> - Who receives updates</span>
                    </li>
                  </ul>
                </div>
                ...
                <div style={{ 
                  ...
                  <p style={{ 
                    ...
                    Create events, manage tasks, and track progress with our intuitive interfaces:
                  </p>
                  <ul style={{
            ...
            <div className="home-content">
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <p style={{ marginBottom: '1.5rem' }}>
                    By implementing the RACI model (Responsible, Accountable, Consulted, Informed), teams gain clarity on who is doing what, reducing confusion and increasing productivity. Our platform transforms traditional RACI charts into an interactive, dynamic system.
                  </p>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <div>
                          ...
                          <p style={{margin: 0, color: '#475569', fontSize: '0.95rem'}}>
                            Eliminate confusion about roles and responsibilities across your organization
                          </p>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div>
                          ...
                          <p style={{margin: 0, color: '#475569', fontSize: '0.95rem'}}>
                            Provide visibility into project structures and progress for stakeholders
                          </p>
                        </div>
                      </div>
                    </div>
